...
class Config:
    def __init__(self) -> None:       
        ...
        #[add]parameter whether if introduce derc
        self.AGGRESSION_DERC_B = False
        ...
        self.AGENT_SIZE = 10 
        self.N_ROBOTS = 5
        self.TIME_LIMIT = 1000*10 #the total length of the simulation!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        self.DT = 0.3 #time step interval of the simulation (effectively this just scales TIME_LIMIT by 1/DT)
